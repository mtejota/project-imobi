  ...
  return (
    <div style={{ padding: '28px 32px', overflowY: 'auto', height: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        ...
        <button style={{ background: '#1a56db', color: '#fff', border: 'none', borderRadius: 12, padding: '10px 20px', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>+ Cadastrar Imóvel</button>
      </div>
          ...
          >
            ...
            <div style={{ padding: '16px 18px' }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button style={{ flex: 1, padding: '8px', borderRadius: 10, border: '1px solid #e2e8f0', background: '#f8fafc', fontSize: 11, fontWeight: 700, color: '#64748b', cursor: 'pointer' }}>Ver detalhes</button>
                <button style={{ flex: 1, padding: '8px', borderRadius: 10, border: 'none', background: '#eff6ff', fontSize: 11, fontWeight: 700, color: '#1a56db', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
